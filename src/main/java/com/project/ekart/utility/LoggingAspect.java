package com.project.ekart.utility;
...
public class LoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.project.ekart.dao.*Impl.*(..))", throwing = "exception")	
	public void logExceptionFromDAO(Exception exception) throws Exception {
		log(exception);
	}
	
	@AfterThrowing(pointcut = "execution(* com.project.ekart.service.*Impl.*(..))", throwing = "exception")	
